...
mixin _$SignInState {
  ...
  Option<Either<AuthFailure, UserModel>> get signInFailureOrSuccess =>
      throw _privateConstructorUsedError;
...
abstract class $SignInStateCopyWith<$Res> {
  ...
  $Res call(
      ...
      Password password,
      bool isLoading,
      Option<Either<AuthFailure, UserModel>> signInFailureOrSuccess});
}
...
class _$_SignInState implements _SignInState {
  ...
  @override
  final Option<Either<AuthFailure, UserModel>> signInFailureOrSuccess;

  @override
  String toString() {
    return 'SignInState(emailAddress: $emailAddress, password: $password, isLoading: $isLoading, signInFailureOrSuccess: $signInFailureOrSuccess)';
  }
